...
class _ClientDashboardState extends ConsumerState<ClientDashboard> {
  ...
  Widget _buildProfileHelpLauncher({
    ...
    return DeskHelpLauncherSection(
      ...
      title: _t(
        ru: 'Откройте инструкцию или чат по нажатию.',
        en: 'Open the guide or support chat in one tap.',
        kk: 'Нұсқаулықты немесе қолдау чатын бір батырмамен ашыңыз.',
      ),
      description: _t(
        ru: 'Длинные блоки больше не занимают экран: инструкция, системный поток и поддержка открываются отдельно.',
        en: 'Long help blocks no longer take over the screen: the guide, system flow, and support open separately.',
        kk: 'Ұзын блоктар экранды алмайды: нұсқаулық, жүйе ағыны және қолдау бөлек ашылады.',
      ),
      actions: [
        DeskHelpLauncherAction(
          ...
          description: _t(
            ru: 'Откройте короткую инструкцию и системный поток заказа.',
            en: 'Open the quick guide and the full order flow.',
            kk: 'Қысқа нұсқаулықты және тапсырыс ағынын ашыңыз.',
          ),
          ...
          onTap: () => showDeskHelpSheet(
            ...
            title: _t(
              ru: 'Вся логика заказа в одном окне.',
              en: 'The whole order flow lives in one place.',
              kk: 'Тапсырыс логикасы бір жерде.',
            ),
            description: _t(
              ru: 'Здесь можно быстро понять, как идёт оформление, трекинг и кто подхватывает заказ на каждом этапе.',
              en: 'Use this sheet to understand checkout, tracking, and who takes over the order at each stage.',
              kk: 'Осы блокта рәсімдеуді, бақылауды және әр кезеңде тапсырысты кім алатынын тез түсінуге болады.',
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
        ...
        DeskHelpLauncherAction(
          ...
          description: _t(
            ru: 'Откройте быстрые действия и скопируйте готовое сообщение для поддержки.',
            en: 'Open quick actions and copy a ready message for support.',
            kk: 'Жедел әрекеттерді ашып, қолдауға арналған дайын хабарламаны көшіріңіз.',
          ),
          ...
          onTap: () => showDeskHelpSheet(
            ...
            title: _t(
              ru: 'Чат и поддержка AVISHU',
              en: 'AVISHU support chat',
              kk: 'AVISHU қолдау чаты',
            ),
            description: _t(
              ru: 'Здесь можно быстро собрать готовое сообщение для адреса, оплаты или номера заказа.',
              en: 'Use this sheet to prepare a ready support message with your address, payment, or order details.',
              kk: 'Осы жерде мекенжай, төлем немесе тапсырыс нөмірі бар дайын қолдау хабарламасын жинастыруға болады.',
            ),
  ...
  Widget _buildProfileGuideSection({required bool compact}) {
    return DeskHelpGuideSection(
      ...
      points: [
        ...
        DeskHelpGuidePoint(
          title: _t(
            ru: 'Если нужно вмешательство, всё под рукой',
    ...
    return DeskHelpSystemFlowSection(
      ...
      steps: [
        ...
        DeskHelpFlowStep(
          ...
          details: _t(
            ru: 'Франчайзи получает заказ сразу после оплаты, проверяет детали и передаёт его в работу без лишних переписок.',
        ...
        DeskHelpFlowStep(
          ...
          details: _t(
            ...
            kk: 'Клиент жаңартуды бақылаудан көреді, дайын мәртебесін алады және тапсырысты алумен циклді аяқтайды.',
          ),
        ),
      ],
    );
      ...
      actions: [
        DeskHelpSupportAction(
          title: _t(
            ...
            kk: 'Чатқа жіберуге арналған хабарламаны көшіру',
          ),
          description: _t(
            ru: 'Одной копией можно разом подтянуть email и номер заказа для чата поддержки.',
            en: 'One copy action prepares a ready message for the support chat with your email and order number.',
            kk: 'Бір көшіру арқылы email мен тапсырыс нөмірі бар дайын қолдау чат хабарламасын аласыз.',
          ),
